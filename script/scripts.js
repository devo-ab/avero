        ...
        <div>
            ...
            <div class="indicator">
               <span class="indicator-item badge ${
                 lets.isActive ? "bg-green-500" : "bg-red-500"
               } "></span>
                ...
                <div>
                    <div>
                        <div class="flex gap-6">
                            <p class="text-sm font-medium leading-4 text-[#12132DCC]">#<span>${
                              lets.category
                            }</span></p>
                            <p class="text-sm font-medium leading-4 text-[#12132DCC]">Author : <span>${
                              lets.author.name
                            }</span></p>
                        </div>

                        <div class="lg:w-[596px] pb-4 border-b-2 border-dashed border-[#12132D40]">
                            <h3 class="text-xl font-bold leading-7 text-[#12132D] mt-2">${
                              lets.title
                            }</h3>
                        ...
                        <div class="flex justify-between">
                            <div class="flex mt-3">
                                <p><i class="fa-regular fa-comment" style="color: #9297a0;"></i><span class="ml-2 leading-5 text-[#12132D99]">${
                                  lets.comment_count
                                }</span></p>

                                <p class="ml-3"><i class="fa-regular fa-eye" style="color: #9399a5;"></i><span class="ml-2 leading-5 text-[#12132D99]">${
                                  lets.view_count
                                }</span></p>

                                <p class="ml-3"><i class="fa-regular fa-clock" style="color: #959aa3;"></i><span class="ml-2 leading-5 text-[#12132D99]"><span>${
                                  lets.posted_time
                                }</span> min</span></p>
                            </div>
                            ...
                            <div onclick="clickAdd(${
                              lets.id
                            })" class="bg-[#10B981] w-fit py-1  px-2 rounded-full mt-3">
...
const clickAdd = async (id) => {
  ...
  const allData = await loadLets();

  const matchData = allData.find((data) => data.id === id);
  ...
  markAsRead.innerHTML = `
    <p class="font-semibold leading-6 text-[#12132D] flex-1">${matchData.title}</p>
    <p class="leading-5 text-[#12132D99]"><i class="fa-regular fa-eye" style="color: #9399a5;"></i><span class="ml-2">${matchData.view_count}</span></p>
    `;
  ...
  latestData.forEach((latest) => {
    ...
    latestCard.innerHTML = `
          ...
          <div class="card-body text-start">
              <p><i class="fa-regular fa-calendar-minus" style="color: #bac2cf;"></i> <span class="leading-5 text-[#12132D99]">${
              ...
              <div class="flex gap-3 items-center mt-2">
                  ...
                  <div>
                      ...
                      <p class="text-sm leading-5 text-[#12132D99]">${
